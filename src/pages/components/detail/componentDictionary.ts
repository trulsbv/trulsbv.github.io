...
const componentModules = import.meta.glob("../../../publicComponents/*/*.tsx", {
  as: "raw",
  eager: true,
});
...
Object.entries(componentModules).forEach(([filePath, content]) => {
  // Extract component name from path (e.g., "publicComponents/Button/Button.tsx" -> "Button")
  ...
  if (
    ...
    // Use the folder name as the key (e.g., "Button" for "publicComponents/Button/Button.tsx")
